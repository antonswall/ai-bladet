...
- **Tester:** `py_compile` ×3, `bash -n`, 28/28 unittester gröna (11 nya: datumhärledning, Moltbook-synlighet, runner-kontrollflöde, podcast-host), `node build.js` (11 utgåvor), `git diff --check`.
