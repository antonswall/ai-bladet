...
function renderAbout() {
  const body = `<article class="about-section">
    ...
    <p>Idén är enkel: AI-världen rör sig för snabbt för att följa varje dag, men för viktigt för att missa. Vi läser veckans nyheter åt dig och destillerar dem till en utgåva du hinner med på några minuter.</p>
