...
briefs_vart_att_veta:
  - "IBM:s Granite PatchTST-FM-r2 använder conformer-block som kombinerar multi-head self-attention med temporal convolution för att fånga både kortsiktiga och långsiktiga mönster i tidsseriedata — en arkitektur som enligt Hugging Face Blog är designad för nollskottsprognoser på okända dataset."
